...
import javax.swing.*;
/** Questo componente da una rappresentazione di un labirinto creato con il metodo newMaze.
  * Per disegnare il labirinto bisogna definire il metodo drawMaze che viene chiamato quando
  * il labirinto subisce qualche modifica o quando il componente viene ridimensionato.
  * Il metodo paint si occupa di disegnare il buffer al centro del componente,
  * quindi drawMaze dovrà disegnare nel buffer e aggiornare opportunamente i campi
  * bufferWidth e bufferHeight. Dovrà inoltre chiamare il metodo repaint per
  * visualizzare quanto disegnato.
  */
public abstract class graphicMaze extends JPanel implements java.io.Serializable{
 ...
 /**direzione in cui e' rivolto il giocatore, si dovrebbero utilizzare i valori della classe direction*/
...
/**Disegna il buffer nel componente. Se il buffer può essere
  *disegnato completamente esso viene posto al centro del componente.
  *Per stabilire le dimensioni del buffer si fa riferimento ai campi
  *bufferWidth e bufferHeight.
  */
...
/**Scrive la stringa s al centro del contesto grafico g.
  *@param g	dove verrà scritto s
  *@param s	ciò che voglio scrivere
  *@param x 	la larghezza dell'immagine in cui si deve scrivere
  *@param y	a che altezza voglio scrivere s
  */
 ...
 *@param c	il nuovo colore dello sfondo
 */
...
/**Setta i campi di questo graphicMaze come quelli di gm in modo che questo
  *componente condivida lo stesso labirinto di gm.
  *Viene chiamato il metodo drawMaze per disegnare il labirinto.
  *@param gm 	il graphicMaze di cui vogliamo rappresentare il labirinto
  */
...
/** Visualizza il labirinto salvato nel file fileName
  * @param fileName 	il nome del file generato da saveMaze(String)
...
/** Salva nel file filename il labirinto e la posizione del giocatore.
  * @param fileName	il nome del file in cui vengono salvati i dati
  * @return true se l'operazione e' andata a buon fine, false altrimenti
  */
...
/** Permette di selezionare la classe che genera i labirinti.
  * Se m e' uguale a null non viene cambiato il generatore di labirinti.
  * @param m 	il nuovo generatore di labirinti
  */
...
/**Crea un nuovo labirinto  e lo disegna chiamando il metodo drawMaze().
  ...
  *per lunghezza e non la dimensione in pixel. Ovvero verra' creato un labirinto
  *maze[length][width] con la classe Maze.
