...
import javax.swing.*;
/**Disegna un labirinto dall'alto e permette di muoversi al suo interno con le frecce direzionali.*/

public class graphicMaze2D extends graphicMaze implements KeyListener, java.io.Serializable{
...
/**Crea un componente inizialmente privo di labirinto.
  ...
  *il componente visualizza l'immagine "maze1.jpg"
  */
...
/**Disegna il percorso per trovare l'uscita dall'inizio del labirinto
  *o dalla posizione corrente del giocatore.
  *@param fromBeginning se è vero verrà trovata la strada dall'inizio
  *			altrimenti da dove si trova il giocatore
  */
...
/**Quando vengono premute le frecce direzionali viene cancellata
 ...
 public void keyPressed(KeyEvent e){
	...
	switch(e.getKeyCode()){
 		case KeyEvent.VK_DOWN:  lookAt = direction.south;
 					break;
 		case KeyEvent.VK_LEFT:  lookAt = direction.west;
 					break;
 		case KeyEvent.VK_RIGHT: lookAt = direction.east;
 					break;
 		case KeyEvent.VK_UP:    lookAt = direction.north;
					break;
 	}
