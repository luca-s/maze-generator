...
import javax.swing.*;
/**Questa classe crea un dialog in cui si possono inserire le dimesioni
  *di un labirinto che verranno passate al metodo newMaze del graphicMaze gm.
  */
public class newMazeDialog extends JDialog implements ActionListener{
 ...
 private graphicMaze gm;
 			   //costruttore
 public newMazeDialog(Frame owner,String title, boolean modal,graphicMaze gm) {
...
/**Controlla che le dimensioni inserite siano dei numeri compresi tra 3 e 250
  * e poi chiama il metodo gm.newMaze con queste dimensioni(se valide).
  */
 public void actionPerformed(ActionEvent e){
